...
class FirDraftCreate(BaseModel):
    ...
    complaint_id is a plain string (e.g. "COMP001"), matching complaints.id
    — it is NOT a UUID. Only the draft's own `id` (see FirDraftResponse) is
    a UUID, generated by the DB.
    """
