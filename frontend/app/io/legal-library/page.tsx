...
export default function LegalLibraryPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      {/* 1. Navbar rendered full-width at the top */}
      <Navbar eyebrow={t("legalLibrary", "dashboard")} title={t("searchLegalSections", "dashboard")} />

      {/* 2. Main layout container holding Sidebar + Main Content */}
      <div className="flex flex-1 min-w-0">
        {/* Sticky Sidebar wrapper */}
        <aside className="sticky top-0 h-[calc(100vh)] self-start shrink-0">
          <Sidebar />
        </aside>

        {/* Main Content Area */}
        <main className="flex-1 min-w-0 space-y-6 px-8 py-6">
